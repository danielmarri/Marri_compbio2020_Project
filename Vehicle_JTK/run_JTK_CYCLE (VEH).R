rm(list = ls())
setwd("C:/Users/marri/Desktop/JTK_PROJECT FOLDER/2020_03_09_Data_understanding_and_visualization/Data_Analysis/Vehicle_JTK")

source("JTK_CYCLE.R")

project <- "Vehicle_Example"

options(stringsAsFactors=FALSE)
annot <- read.delim("Vehicle_Annot.txt")
data <- read.delim("Vehicle_Data.txt")
